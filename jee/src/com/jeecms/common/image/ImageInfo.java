...
/*	public static final int COLOR_TYPE_UNKNOWN = -1;
	...
	private void addComment(String s) {
		if (logger.isDebugEnabled()) {
			logger.debug("addComment(String) - start"); //$NON-NLS-1$
		}
		...
		if (logger.isDebugEnabled()) {
			logger.debug("addComment(String) - end"); //$NON-NLS-1$
		}
	}
	...
	public boolean check() {
		if (logger.isDebugEnabled()) {
			logger.debug("check() - start"); //$NON-NLS-1$
		}
		...
		try {
			...
			int b2 = read() & 0xff;
			if (b1 == 0x47 && b2 == 0x49) {
				boolean returnboolean = checkGif();
				if (logger.isDebugEnabled()) {
					logger.debug("check() - end"); //$NON-NLS-1$
				}
				return returnboolean;
			}
			else
			if (b1 == 0x89 && b2 == 0x50) {
				boolean returnboolean = checkPng();
				if (logger.isDebugEnabled()) {
					logger.debug("check() - end"); //$NON-NLS-1$
				}
				return returnboolean;
			...
			if (b1 == 0xff && b2 == 0xd8) {
				boolean returnboolean = checkJpeg();
				if (logger.isDebugEnabled()) {
					logger.debug("check() - end"); //$NON-NLS-1$
				}
				return returnboolean;
			...
			if (b1 == 0x42 && b2 == 0x4d) {
				boolean returnboolean = checkBmp();
				if (logger.isDebugEnabled()) {
					logger.debug("check() - end"); //$NON-NLS-1$
				}
				return returnboolean;
			...
			if (b1 == 0x0a && b2 < 0x06) {
				boolean returnboolean = checkPcx();
				if (logger.isDebugEnabled()) {
					logger.debug("check() - end"); //$NON-NLS-1$
				}
				return returnboolean;
			...
			if (b1 == 0x46 && b2 == 0x4f) {
				boolean returnboolean = checkIff();
				if (logger.isDebugEnabled()) {
					logger.debug("check() - end"); //$NON-NLS-1$
				}
				return returnboolean;
			...
			if (b1 == 0x59 && b2 == 0xa6) {
				boolean returnboolean = checkRas();
				if (logger.isDebugEnabled()) {
					logger.debug("check() - end"); //$NON-NLS-1$
				}
				return returnboolean;
			...
			if (b1 == 0x50 && b2 >= 0x31 && b2 <= 0x36) {
				boolean returnboolean = checkPnm(b2 - '0');
				if (logger.isDebugEnabled()) {
					logger.debug("check() - end"); //$NON-NLS-1$
				}
				return returnboolean;
			...
			if (b1 == 0x38 && b2 == 0x42) {
				boolean returnboolean = checkPsd();
				if (logger.isDebugEnabled()) {
					logger.debug("check() - end"); //$NON-NLS-1$
				}
				return returnboolean;
			...
			logger.error("check()", ioe); //$NON-NLS-1$
	...
	private boolean checkBmp() throws IOException {
		if (logger.isDebugEnabled()) {
			logger.debug("checkBmp() - start"); //$NON-NLS-1$
		}

		byte[] a = new byte[44];
		if (read(a) != a.length) {
			if (logger.isDebugEnabled()) {
				logger.debug("checkBmp() - end"); //$NON-NLS-1$
			}
			return false;
		}
	...
	private boolean checkGif() throws IOException {
		if (logger.isDebugEnabled()) {
			logger.debug("checkGif() - start"); //$NON-NLS-1$
		}
		...
		if (read(a) != 11) {
			if (logger.isDebugEnabled()) {
				logger.debug("checkGif() - end"); //$NON-NLS-1$
			}
			return false;
		}
	...
	private boolean checkIff() throws IOException {
		if (logger.isDebugEnabled()) {
			logger.debug("checkIff() - start"); //$NON-NLS-1$
		}
		...
		if (read(a, 0, 10) != 10) {
			if (logger.isDebugEnabled()) {
				logger.debug("checkIff() - end"); //$NON-NLS-1$
			}
			return false;
		}
		...
		do {
			...
			if (chunkId == 0x424d4844) { // BMHD chunk
				...
				boolean returnboolean = (width > 0 && height > 0 && bitsPerPixel > 0 && bitsPerPixel < 33);
				if (logger.isDebugEnabled()) {
					logger.debug("checkIff() - end"); //$NON-NLS-1$
				}
				return returnboolean;
	...
	private boolean checkJpeg() throws IOException {
		if (logger.isDebugEnabled()) {
			logger.debug("checkJpeg() - start"); //$NON-NLS-1$
		}
		...
		while (true) {
			if (read(data, 0, 4) != 4) {
				if (logger.isDebugEnabled()) {
					logger.debug("checkJpeg() - end"); //$NON-NLS-1$
				}
				return false;
			}
	...
	private boolean checkPcx() throws IOException {
		if (logger.isDebugEnabled()) {
			logger.debug("checkPcx() - start"); //$NON-NLS-1$
		}

		byte[] a = new byte[64];
		if (read(a) != a.length) {
			if (logger.isDebugEnabled()) {
				logger.debug("checkPcx() - end"); //$NON-NLS-1$
			}
			return false;
		}
	...
	private boolean checkPng() throws IOException {
		if (logger.isDebugEnabled()) {
			logger.debug("checkPng() - start"); //$NON-NLS-1$
		}
		...
		if (read(a) != 27) {
			if (logger.isDebugEnabled()) {
				logger.debug("checkPng() - end"); //$NON-NLS-1$
			}
			return false;
		}
	...
	private boolean checkPnm(int id) throws IOException {
		if (logger.isDebugEnabled()) {
			logger.debug("checkPnm(int) - start"); //$NON-NLS-1$
		}

		if (id < 1 || id > 6) {
			if (logger.isDebugEnabled()) {
				logger.debug("checkPnm(int) - end"); //$NON-NLS-1$
			}
			return false;
		}
		...
		while (true)
		{
			...
			if (!hasPixelResolution) { // split "343 966" into width=343, height=966
				...
				try {
					...
					logger.error("checkPnm(int)", nfe); //$NON-NLS-1$
	...
	private boolean checkPsd() throws IOException {
		if (logger.isDebugEnabled()) {
			logger.debug("checkPsd() - start"); //$NON-NLS-1$
		}

		byte[] a = new byte[24];
		if (read(a) != a.length) {
			if (logger.isDebugEnabled()) {
				logger.debug("checkPsd() - end"); //$NON-NLS-1$
			}
			return false;
		}
		...
		boolean returnboolean = (width > 0 && height > 0 && bitsPerPixel > 0 && bitsPerPixel <= 64);
		if (logger.isDebugEnabled()) {
			logger.debug("checkPsd() - end"); //$NON-NLS-1$
		}
		return returnboolean;
	...
	private boolean checkRas() throws IOException {
		if (logger.isDebugEnabled()) {
			logger.debug("checkRas() - start"); //$NON-NLS-1$
		}

		byte[] a = new byte[14];
		if (read(a) != a.length) {
			if (logger.isDebugEnabled()) {
				logger.debug("checkRas() - end"); //$NON-NLS-1$
			}
			return false;
		}
		...
		boolean returnboolean = (width > 0 && height > 0 && bitsPerPixel > 0 && bitsPerPixel <= 24);
		if (logger.isDebugEnabled()) {
			logger.debug("checkRas() - end"); //$NON-NLS-1$
		}
		return returnboolean;
	...
	private static boolean determineVerbosity(String[] args) {
		if (logger.isDebugEnabled()) {
			logger.debug("determineVerbosity(String[]) - start"); //$NON-NLS-1$
		}
		...
		if (args != null && args.length > 0) {
			for (int i = 0; i < args.length; i++) {
				if ("-c".equals(args[i])) {
					if (logger.isDebugEnabled()) {
						logger.debug("determineVerbosity(String[]) - end"); //$NON-NLS-1$
					}
					return false;
				}
			}
	...
	private static boolean equals(byte[] a1, int offs1, byte[] a2, int offs2, int num) {
		if (logger.isDebugEnabled()) {
			logger.debug("equals(byte[], int, byte[], int, int) - start"); //$NON-NLS-1$
		}

		while (num-- > 0) {
			if (a1[offs1++] != a2[offs2++]) {
				if (logger.isDebugEnabled()) {
					logger.debug("equals(byte[], int, byte[], int, int) - end"); //$NON-NLS-1$
				}
				return false;
			}
		}
	...
	public String getComment(int index) {
		if (logger.isDebugEnabled()) {
			logger.debug("getComment(int) - start"); //$NON-NLS-1$
		}

		if (comments == null || index < 0 || index >= comments.size()) {
			throw new IllegalArgumentException("Not a valid comment index: " + index);
		}
		String returnString = (String) comments.elementAt(index);
		if (logger.isDebugEnabled()) {
			logger.debug("getComment(int) - end"); //$NON-NLS-1$
		}
		return returnString;
	}
	...
	public String getFormatName() {
		if (logger.isDebugEnabled()) {
			logger.debug("getFormatName() - start"); //$NON-NLS-1$
		}

		if (format >= 0 && format < FORMAT_NAMES.length) {
			String returnString = FORMAT_NAMES[format];
			if (logger.isDebugEnabled()) {
				logger.debug("getFormatName() - end"); //$NON-NLS-1$
			}
			return returnString;
		} else {
			if (logger.isDebugEnabled()) {
	...
	private static int getIntBigEndian(byte[] a, int offs) {
		if (logger.isDebugEnabled()) {
			logger.debug("getIntBigEndian(byte[], int) - start"); //$NON-NLS-1$
		}

		int returnint = (a[offs] & 0xff) << 24 | (a[offs + 1] & 0xff) << 16 | (a[offs + 2] & 0xff) << 8 | a[offs + 3] & 0xff;
		if (logger.isDebugEnabled()) {
			logger.debug("getIntBigEndian(byte[], int) - end"); //$NON-NLS-1$
		}
		return
			 returnint;
	}
	...
	private static int getIntLittleEndian(byte[] a, int offs) {
		if (logger.isDebugEnabled()) {
			logger.debug("getIntLittleEndian(byte[], int) - start"); //$NON-NLS-1$
		}

		int returnint = (a[offs + 3] & 0xff) << 24 | (a[offs + 2] & 0xff) << 16 | (a[offs + 1] & 0xff) << 8 | a[offs] & 0xff;
		if (logger.isDebugEnabled()) {
			logger.debug("getIntLittleEndian(byte[], int) - end"); //$NON-NLS-1$
		}
		return
			 returnint;
	}
	...
	public String getMimeType() {
		if (logger.isDebugEnabled()) {
			logger.debug("getMimeType() - start"); //$NON-NLS-1$
		}
		...
		if (format >= 0 && format < MIME_TYPE_STRINGS.length) {
			...
			{
				if (logger.isDebugEnabled()) {
					logger.debug("getMimeType() - end"); //$NON-NLS-1$
				}
				return "image/pjpeg";
			}
			String returnString = MIME_TYPE_STRINGS[format];
			if (logger.isDebugEnabled()) {
				logger.debug("getMimeType() - end"); //$NON-NLS-1$
			}
			return returnString;
	...
	{
		if (logger.isDebugEnabled()) {
			logger.debug("getNumberOfComments() - start"); //$NON-NLS-1$
		}

		if (comments == null) {
			if (logger.isDebugEnabled()) {
				logger.debug("getNumberOfComments() - end"); //$NON-NLS-1$
			}
			return 0;
		} else {
			int returnint = comments.size();
			if (logger.isDebugEnabled()) {
				logger.debug("getNumberOfComments() - end"); //$NON-NLS-1$
			}
			return returnint;
	...
	public float getPhysicalHeightInch() {
		if (logger.isDebugEnabled()) {
			logger.debug("getPhysicalHeightInch() - start"); //$NON-NLS-1$
		}

		int h = getHeight();
		int ph = getPhysicalHeightDpi();
		if (h > 0 && ph > 0) {
			float returnfloat = ((float) h) / ((float) ph);
			if (logger.isDebugEnabled()) {
				logger.debug("getPhysicalHeightInch() - end"); //$NON-NLS-1$
			}
			return returnfloat;
		} else {
	...
	public float getPhysicalWidthInch() {
		if (logger.isDebugEnabled()) {
			logger.debug("getPhysicalWidthInch() - start"); //$NON-NLS-1$
		}

		int w = getWidth();
		int pw = getPhysicalWidthDpi();
		if (w > 0 && pw > 0) {
			float returnfloat = ((float) w) / ((float) pw);
			if (logger.isDebugEnabled()) {
				logger.debug("getPhysicalWidthInch() - end"); //$NON-NLS-1$
			}
			return returnfloat;
		} else {
			float returnfloat = -1.0f;
	...
	private static int getShortBigEndian(byte[] a, int offs) {
		if (logger.isDebugEnabled()) {
			logger.debug("getShortBigEndian(byte[], int) - start"); //$NON-NLS-1$
		}

		int returnint = (a[offs] & 0xff) << 8 | (a[offs + 1] & 0xff);
		if (logger.isDebugEnabled()) {
			logger.debug("getShortBigEndian(byte[], int) - end"); //$NON-NLS-1$
		}
		return
			 returnint;
	}
	...
	private static int getShortLittleEndian(byte[] a, int offs) {
		if (logger.isDebugEnabled()) {
			logger.debug("getShortLittleEndian(byte[], int) - start"); //$NON-NLS-1$
		}

		int returnint = (a[offs] & 0xff) | (a[offs + 1] & 0xff) << 8;
		if (logger.isDebugEnabled()) {
			logger.debug("getShortLittleEndian(byte[], int) - end"); //$NON-NLS-1$
		}
		return returnint;
	}
			...
			while (index < args.length) {
				...
				try {
					...
					try {
						...
						logger.warn("main(String[]) - exception ignored", ee); //$NON-NLS-1$
					}
				}
			}
		}
	...
	private static void print(String sourceName, ImageInfo ii, boolean verbose) {
		if (logger.isDebugEnabled()) {
			logger.debug("print(String, ImageInfo, boolean) - start"); //$NON-NLS-1$
		}
		...
		if (logger.isDebugEnabled()) {
			logger.debug("print(String, ImageInfo, boolean) - end"); //$NON-NLS-1$
		}
	}

	private static void printCompact(String sourceName, ImageInfo imageInfo) {
		if (logger.isDebugEnabled()) {
			logger.debug("printCompact(String, ImageInfo) - start"); //$NON-NLS-1$
		}
		...
		if (logger.isDebugEnabled()) {
			logger.debug("printCompact(String, ImageInfo) - end"); //$NON-NLS-1$
		}
	}

	private static void printLine(int indentLevels, String text, float value, float minValidValue) {
		if (logger.isDebugEnabled()) {
			logger.debug("printLine(int, String, float, float) - start"); //$NON-NLS-1$
		}

		if (value < minValidValue) {
			if (logger.isDebugEnabled()) {
				logger.debug("printLine(int, String, float, float) - end"); //$NON-NLS-1$
			}
			return;
		}
	...
	private static void printLine(int indentLevels, String text, int value, int minValidValue) {
		if (logger.isDebugEnabled()) {
			logger.debug("printLine(int, String, int, int) - start"); //$NON-NLS-1$
		}
		...
		if (logger.isDebugEnabled()) {
			logger.debug("printLine(int, String, int, int) - end"); //$NON-NLS-1$
		}
	}

	private static void printLine(int indentLevels, String text, String value) {
		if (logger.isDebugEnabled()) {
			logger.debug("printLine(int, String, String) - start"); //$NON-NLS-1$
		}

		if (value == null || value.length() == 0) {
			if (logger.isDebugEnabled()) {
				logger.debug("printLine(int, String, String) - end"); //$NON-NLS-1$
			}
			return;
		}
	...
	private static void printVerbose(String sourceName, ImageInfo ii) {
		if (logger.isDebugEnabled()) {
			logger.debug("printVerbose(String, ImageInfo) - start"); //$NON-NLS-1$
		}
		...
		if (logger.isDebugEnabled()) {
			logger.debug("printVerbose(String, ImageInfo) - end"); //$NON-NLS-1$
		}
	}
	...
	private int read(byte[] a, int offset, int num) throws IOException {
		...
		if (in != null) {
			int returnint = in.read(a, offset, num);
			if (logger.isDebugEnabled()) {
	...
	private String readLine() throws IOException {
		if (logger.isDebugEnabled()) {
			logger.debug("readLine() - start"); //$NON-NLS-1$
		}

		String returnString = readLine(new StringBuffer());
		if (logger.isDebugEnabled()) {
			logger.debug("readLine() - end"); //$NON-NLS-1$
		}
		return returnString;
	}
	...
	private String readLine(StringBuffer sb) throws IOException {
		if (logger.isDebugEnabled()) {
			logger.debug("readLine(StringBuffer) - start"); //$NON-NLS-1$
		}
		...
		if (logger.isDebugEnabled()) {
			logger.debug("readLine(StringBuffer) - end"); //$NON-NLS-1$
		}
		return returnString;
	}
	...
	private static void run(String sourceName, InputStream in, ImageInfo imageInfo, boolean verbose) {
		if (logger.isDebugEnabled()) {
			logger.debug("run(String, InputStream, ImageInfo, boolean) - start"); //$NON-NLS-1$
		}
		...
		if (logger.isDebugEnabled()) {
			logger.debug("run(String, InputStream, ImageInfo, boolean) - end"); //$NON-NLS-1$
		}
	}
	...
	public void setInput(DataInput dataInput) {
		if (logger.isDebugEnabled()) {
			logger.debug("setInput(DataInput) - start"); //$NON-NLS-1$
		}
		...
		if (logger.isDebugEnabled()) {
			logger.debug("setInput(DataInput) - end"); //$NON-NLS-1$
		}
	}
	...
	public void setInput(InputStream inputStream) {
		if (logger.isDebugEnabled()) {
			logger.debug("setInput(InputStream) - start"); //$NON-NLS-1$
		}
		...
		if (logger.isDebugEnabled()) {
			logger.debug("setInput(InputStream) - end"); //$NON-NLS-1$
		}
	}
    ...
    private void skip(int num) throws IOException {
		if (logger.isDebugEnabled()) {
			logger.debug("skip(int) - start"); //$NON-NLS-1$
		}
		...
		if (logger.isDebugEnabled()) {
			logger.debug("skip(int) - end"); //$NON-NLS-1$
		}
    }
}
