 ...
 * </ul>
 * 
 * @version $Id: ResourceType.java,v 1.1 2011/12/26 03:47:53 Administrator Exp $
 */
public class ResourceType {
	...
	public Set<String> getAllowedEextensions() {
		if (logger.isDebugEnabled()) {
			logger.debug("getAllowedEextensions() - start"); //$NON-NLS-1$
		}

		Set<String> returnSet = Collections.unmodifiableSet(allowedEextensions);
		if (logger.isDebugEnabled()) {
			logger.debug("getAllowedEextensions() - end"); //$NON-NLS-1$
		}
		return returnSet;
	}
	...
	public Set<String> getDeniedExtensions() {
		if (logger.isDebugEnabled()) {
			logger.debug("getDeniedExtensions() - start"); //$NON-NLS-1$
		}

		Set<String> returnSet = Collections.unmodifiableSet(deniedExtensions);
		if (logger.isDebugEnabled()) {
			logger.debug("getDeniedExtensions() - end"); //$NON-NLS-1$
		}
		return returnSet;
	}
	...
	public static ResourceType valueOf(final String name) {
		if (logger.isDebugEnabled()) {
			logger.debug("valueOf(String) - start"); //$NON-NLS-1$
		}
		...
		if (logger.isDebugEnabled()) {
			logger.debug("valueOf(String) - end"); //$NON-NLS-1$
		}
		return rt;
	}
	...
	public static boolean isValidType(final String name) {
		if (logger.isDebugEnabled()) {
			logger.debug("isValidType(String) - start"); //$NON-NLS-1$
		}

		// HashMap permits null keys, so it will return false in that case
		boolean returnboolean = types.containsKey(name);
		if (logger.isDebugEnabled()) {
			logger.debug("isValidType(String) - end"); //$NON-NLS-1$
		}
	...
	public static ResourceType getResourceType(final String name) {
		if (logger.isDebugEnabled()) {
			logger.debug("getResourceType(String) - start"); //$NON-NLS-1$
		}

		try {
			ResourceType returnResourceType = ResourceType.valueOf(name);
			if (logger.isDebugEnabled()) {
				logger.debug("getResourceType(String) - end"); //$NON-NLS-1$
			}
			return returnResourceType;
		} catch (Exception e) {
			logger.error("getResourceType(String)", e); //$NON-NLS-1$
	...
	public static ResourceType getDefaultResourceType(final String name) {
		if (logger.isDebugEnabled()) {
			logger.debug("getDefaultResourceType(String) - start"); //$NON-NLS-1$
		}

		ResourceType rt = getResourceType(name);
		ResourceType returnResourceType = rt == null ? FILE : rt;
		if (logger.isDebugEnabled()) {
			logger.debug("getDefaultResourceType(String) - end"); //$NON-NLS-1$
		}
		return returnResourceType;
	}
	...
	public boolean isAllowedExtension(final String extension) {
		if (logger.isDebugEnabled()) {
			logger.debug("isAllowedExtension(String) - start"); //$NON-NLS-1$
		}
		...
		if (logger.isDebugEnabled()) {
			logger.debug("isAllowedExtension(String) - end"); //$NON-NLS-1$
		}
		return false;
	}
	...
	public boolean isNotAllowedExtension(final String extension) {
		if (logger.isDebugEnabled()) {
			logger.debug("isNotAllowedExtension(String) - start"); //$NON-NLS-1$
		}

		boolean returnboolean = !isAllowedExtension(extension);
		if (logger.isDebugEnabled()) {
			logger.debug("isNotAllowedExtension(String) - end"); //$NON-NLS-1$
		}
		return returnboolean;
	}
	...
	public boolean isDeniedExtension(final String extension) {
		if (logger.isDebugEnabled()) {
			logger.debug("isDeniedExtension(String) - start"); //$NON-NLS-1$
		}

		boolean returnboolean = !isAllowedExtension(extension);
		if (logger.isDebugEnabled()) {
			logger.debug("isDeniedExtension(String) - end"); //$NON-NLS-1$
		}
		return returnboolean;
	}
