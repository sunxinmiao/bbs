 ...
 * </p>
 * 
 * @version $Id: UploadResponse.java,v 1.1 2011/12/26 03:47:53 Administrator Exp $
 */
public class UploadResponse {
	/**
	 * Logger for this class
	 */
	private static final Logger logger = Logger.getLogger(UploadResponse.class);
	...
	public void setCustomMessage(final String customMassage) {
		if (logger.isDebugEnabled()) {
			logger.debug("setCustomMessage(String) - start"); //$NON-NLS-1$
		}
		...
		if (logger.isDebugEnabled()) {
			logger.debug("setCustomMessage(String) - end"); //$NON-NLS-1$
		}
	}
	...
	public static UploadResponse getOK(HttpServletRequest request,
			String fileUrl) {
		if (logger.isDebugEnabled()) {
			logger.debug("getOK(HttpServletRequest, String) - start"); //$NON-NLS-1$
		}

		UploadResponse returnUploadResponse = new UploadResponse(EN_OK, fileUrl);
		if (logger.isDebugEnabled()) {
			logger.debug("getOK(HttpServletRequest, String) - end"); //$NON-NLS-1$
		}
		return returnUploadResponse;
	}
	...
	public static UploadResponse getFileRenamedWarning(
		...
		if (logger.isDebugEnabled()) {
			logger.debug("getFileRenamedWarning(HttpServletRequest, String, String) - start"); //$NON-NLS-1$
		}

		UploadResponse returnUploadResponse = new UploadResponse(EN_FILE_RENAMED_WARNING, fileUrl, newFileName, LocalizedMessages.getFileRenamedWarning(request, newFileName));
		if (logger.isDebugEnabled()) {
			logger.debug("getFileRenamedWarning(HttpServletRequest, String, String) - end"); //$NON-NLS-1$
		}
		return returnUploadResponse;
	}
	...
	public static UploadResponse getInvalidFileTypeError(
		...
		if (logger.isDebugEnabled()) {
			logger.debug("getInvalidFileTypeError(HttpServletRequest) - start"); //$NON-NLS-1$
		}

		UploadResponse returnUploadResponse = new UploadResponse(EN_INVALID_FILE_TYPE_ERROR, LocalizedMessages.getInvalidFileTypeSpecified(request));
		if (logger.isDebugEnabled()) {
			logger.debug("getInvalidFileTypeError(HttpServletRequest) - end"); //$NON-NLS-1$
		}
		return returnUploadResponse;
	}
	...
	public static UploadResponse getInvalidCommandError(
			HttpServletRequest request) {
		if (logger.isDebugEnabled()) {
			logger.debug("getInvalidCommandError(HttpServletRequest) - start"); //$NON-NLS-1$
		}

		UploadResponse returnUploadResponse = new UploadResponse(EN_CUSTOM_ERROR, null, null, LocalizedMessages.getInvalidCommandSpecified(request));
		if (logger.isDebugEnabled()) {
			logger.debug("getInvalidCommandError(HttpServletRequest) - end"); //$NON-NLS-1$
		}
		return returnUploadResponse;
	}
	...
	public static UploadResponse getInvalidResourceTypeError(
			HttpServletRequest request) {
		if (logger.isDebugEnabled()) {
			logger.debug("getInvalidResourceTypeError(HttpServletRequest) - start"); //$NON-NLS-1$
		}

		UploadResponse returnUploadResponse = new UploadResponse(EN_CUSTOM_ERROR, null, null, LocalizedMessages.getInvalidResouceTypeSpecified(request));
		if (logger.isDebugEnabled()) {
			logger.debug("getInvalidResourceTypeError(HttpServletRequest) - end"); //$NON-NLS-1$
		}
		return returnUploadResponse;
	}
	...
	public static UploadResponse getInvalidCurrentFolderError(
			HttpServletRequest request) {
		if (logger.isDebugEnabled()) {
			logger.debug("getInvalidCurrentFolderError(HttpServletRequest) - start"); //$NON-NLS-1$
		}

		UploadResponse returnUploadResponse = new UploadResponse(EN_CUSTOM_ERROR, null, null, LocalizedMessages.getInvalidCurrentFolderSpecified(request));
		if (logger.isDebugEnabled()) {
			logger.debug("getInvalidCurrentFolderError(HttpServletRequest) - end"); //$NON-NLS-1$
		}
		return returnUploadResponse;
	}
	...
	public static UploadResponse getFileUploadDisabledError(
			HttpServletRequest request) {
		if (logger.isDebugEnabled()) {
			logger.debug("getFileUploadDisabledError(HttpServletRequest) - start"); //$NON-NLS-1$
		}

		UploadResponse returnUploadResponse = new UploadResponse(EN_SECURITY_ERROR, null, null, LocalizedMessages.getFileUploadDisabled(request));
		if (logger.isDebugEnabled()) {
			logger.debug("getFileUploadDisabledError(HttpServletRequest) - end"); //$NON-NLS-1$
		}
		return returnUploadResponse;
	}
	...
	public static UploadResponse getFileUploadWriteError(
		...
		UploadResponse returnUploadResponse = new UploadResponse(EN_CUSTOM_ERROR, null, null, LocalizedMessages.getFileUploadWriteError(request));
		if (logger.isDebugEnabled()) {
