...
public class FilePart extends Part {
	 ...
	 */
	private static final Logger logger = Logger.getLogger(FilePart.class);
  ...
  public long writeTo(File fileOrDirectory) throws IOException {
		if (logger.isDebugEnabled()) {
			logger.debug("writeTo(File) - start"); //$NON-NLS-1$
		}
	...
	if (logger.isDebugEnabled()) {
			logger.debug("writeTo(File) - end"); //$NON-NLS-1$
		}
    return written;
  }
  ...
  public long writeTo(OutputStream out) throws IOException {
		if (logger.isDebugEnabled()) {
			logger.debug("writeTo(OutputStream) - start"); //$NON-NLS-1$
		}
	...
	if (logger.isDebugEnabled()) {
			logger.debug("writeTo(OutputStream) - end"); //$NON-NLS-1$
		}
    return size;
  }
  ...
  long write(OutputStream out) throws IOException {
		if (logger.isDebugEnabled()) {
			logger.debug("write(OutputStream) - start"); //$NON-NLS-1$
		}
	...
	if (logger.isDebugEnabled()) {
			logger.debug("write(OutputStream) - end"); //$NON-NLS-1$
		}
    return size;
  }
