...
public class MacBinaryDecoderOutputStream extends FilterOutputStream {
	 ...
	 */
	private static final Logger logger = Logger.getLogger(MacBinaryDecoderOutputStream.class);
  ...
  public void write(int b) throws IOException {
		if (logger.isDebugEnabled()) {
			logger.debug("write(int) - start"); //$NON-NLS-1$
		}
	...
	if (logger.isDebugEnabled()) {
			logger.debug("write(int) - end"); //$NON-NLS-1$
		}
  }

  public void write(byte b[]) throws IOException {
		if (logger.isDebugEnabled()) {
			logger.debug("write(byte[]) - start"); //$NON-NLS-1$
		}

    write(b, 0, b.length);

	if (logger.isDebugEnabled()) {
			logger.debug("write(byte[]) - end"); //$NON-NLS-1$
		}
  }

  public void write(byte b[], int off, int len) throws IOException {
		if (logger.isDebugEnabled()) {
			logger.debug("write(byte[], int, int) - start"); //$NON-NLS-1$
		}
	...
	if (logger.isDebugEnabled()) {
			logger.debug("write(byte[], int, int) - end"); //$NON-NLS-1$
		}
  }
}
