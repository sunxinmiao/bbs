...
public class URLHelper {
	...
	public static int getPageNo(HttpServletRequest request) {
		if (logger.isDebugEnabled()) {
			logger.debug("getPageNo(HttpServletRequest) - start"); //$NON-NLS-1$
		}

		int returnint = getPageNo(getURI(request));
		if (logger.isDebugEnabled()) {
			logger.debug("getPageNo(HttpServletRequest) - end"); //$NON-NLS-1$
		}
		return returnint;
	}
	...
	public static String[] getPaths(HttpServletRequest request) {
		if (logger.isDebugEnabled()) {
			logger.debug("getPaths(HttpServletRequest) - start"); //$NON-NLS-1$
		}

		String[] returnStringArray = getPaths(getURI(request));
		if (logger.isDebugEnabled()) {
			logger.debug("getPaths(HttpServletRequest) - end"); //$NON-NLS-1$
		}
	...
	public static String[] getParams(HttpServletRequest request) {
		if (logger.isDebugEnabled()) {
			logger.debug("getParams(HttpServletRequest) - start"); //$NON-NLS-1$
		}

		String[] returnStringArray = getParams(getURI(request));
		if (logger.isDebugEnabled()) {
			logger.debug("getParams(HttpServletRequest) - end"); //$NON-NLS-1$
		}
		return returnStringArray;
	}
	...
	private static String getURI(HttpServletRequest request) {
		...
		if (!StringUtils.isBlank(ctx)) {
			String returnString = uri.substring(ctx.length());
			if (logger.isDebugEnabled()) {
	...
	public static PageInfo getPageInfo(HttpServletRequest request) {
		if (logger.isDebugEnabled()) {
			logger.debug("getPageInfo(HttpServletRequest) - start"); //$NON-NLS-1$
		}

		UrlPathHelper helper = new UrlPathHelper();
		String uri = helper.getOriginatingRequestUri(request);
		String queryString = helper.getOriginatingQueryString(request);
		PageInfo returnPageInfo = getPageInfo(uri, queryString);
		if (logger.isDebugEnabled()) {
			logger.debug("getPageInfo(HttpServletRequest) - end"); //$NON-NLS-1$
		}
	...
	public static int getPageNo(String uri) {
		if (logger.isDebugEnabled()) {
			logger.debug("getPageNo(String) - start"); //$NON-NLS-1$
		}
		...
		if (bi != -1) {
			...
			try {
				...
				logger.warn("getPageNo(String) - exception ignored", e); //$NON-NLS-1$
			}
		}

		if (logger.isDebugEnabled()) {
			logger.debug("getPageNo(String) - end"); //$NON-NLS-1$
		}
		return pageNo;
	}
	...
	public static String[] getPaths(String uri) {
		if (logger.isDebugEnabled()) {
			logger.debug("getPaths(String) - start"); //$NON-NLS-1$
		}
		...
		if (logger.isDebugEnabled()) {
			logger.debug("getPaths(String) - end"); //$NON-NLS-1$
		}
		return paths;
	}
	...
	public static String[] getParams(String uri) {
		if (logger.isDebugEnabled()) {
			logger.debug("getParams(String) - start"); //$NON-NLS-1$
		}
		...
		if (logger.isDebugEnabled()) {
			logger.debug("getParams(String) - end"); //$NON-NLS-1$
		}
		return params;
	}
	...
	public static PageInfo getPageInfo(String uri, String queryString) {
		if (logger.isDebugEnabled()) {
			logger.debug("getPageInfo(String, String) - start"); //$NON-NLS-1$
		}

		if (uri == null) {
			if (logger.isDebugEnabled()) {
				logger.debug("getPageInfo(String, String) - end"); //$NON-NLS-1$
			}
			return null;
		}
		if (!uri.startsWith("/")) {
		...
		PageInfo returnPageInfo = new PageInfo(href, urlFormer, urlLater);
		if (logger.isDebugEnabled()) {
			logger.debug("getPageInfo(String, String) - end"); //$NON-NLS-1$
		}
		return returnPageInfo;
