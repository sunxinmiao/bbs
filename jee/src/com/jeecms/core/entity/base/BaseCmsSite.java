...
/**
 * This is an object that contains data related to the jc_site table. Do not
...
public abstract class BaseCmsSite implements Serializable {
	 ...
	 */
	private static final Logger logger = Logger.getLogger(BaseCmsSite.class);
	...
	private com.jeecms.bbs.entity.BbsCreditExchange creditExchange;
	...
	public void setId(java.lang.Integer id) {
		if (logger.isDebugEnabled()) {
			logger.debug("setId(java.lang.Integer) - start"); //$NON-NLS-1$
		}
		...
		if (logger.isDebugEnabled()) {
			logger.debug("setId(java.lang.Integer) - end"); //$NON-NLS-1$
		}
	}
	...
	public com.jeecms.bbs.entity.BbsCreditExchange getCreditExchange() {
		return creditExchange;
	}

	public void setCreditExchange(
			com.jeecms.bbs.entity.BbsCreditExchange creditExchange) {
	...
	public boolean equals(Object obj) {
		if (null == obj)
			return false;
		if (!(obj instanceof com.jeecms.core.entity.CmsSite))
			return false;
		else {
			com.jeecms.core.entity.CmsSite cmsSite = (com.jeecms.core.entity.CmsSite) obj;
			if (null == this.getId() || null == cmsSite.getId())
				return false;
			else
				return (this.getId().equals(cmsSite.getId()));
		}
	}
