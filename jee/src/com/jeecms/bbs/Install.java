...
public class Install {
	...
	public static void dbXml(String fileName, String dbHost, String dbPort,
		...
		if (logger.isDebugEnabled()) {
			logger.debug("dbXml(String, String, String, String, String, String) - start"); //$NON-NLS-1$
		}
		...
		if (logger.isDebugEnabled()) {
			logger.debug("dbXml(String, String, String, String, String, String) - end"); //$NON-NLS-1$
		}
	}
	...
	public static Connection getConn(String dbHost, String dbPort,
			String dbName, String dbUser, String dbPassword) throws Exception {
		if (logger.isDebugEnabled()) {
			logger.debug("getConn(String, String, String, String, String) - start"); //$NON-NLS-1$
		}
		...
		if (logger.isDebugEnabled()) {
			logger.debug("getConn(String, String, String, String, String) - end"); //$NON-NLS-1$
		}
		return conn;
	}
	...
	public static void webXml(String fromFile, String toFile) throws Exception {
		if (logger.isDebugEnabled()) {
			logger.debug("webXml(String, String) - start"); //$NON-NLS-1$
		}

		FileUtils.copyFile(new File(fromFile), new File(toFile));

		if (logger.isDebugEnabled()) {
			logger.debug("webXml(String, String) - end"); //$NON-NLS-1$
		}
	}
	...
	public static void createDb(String dbHost, String dbPort, String dbName,
		...
		if (logger.isDebugEnabled()) {
			logger.debug("createDb(String, String, String, String, String) - start"); //$NON-NLS-1$
		}
		...
		if (logger.isDebugEnabled()) {
			logger.debug("createDb(String, String, String, String, String) - end"); //$NON-NLS-1$
		}
	}
	...
	public static void changeDbCharset(String dbHost, String dbPort,
			String dbName, String dbUser, String dbPassword) throws Exception {
		if (logger.isDebugEnabled()) {
			logger.debug("changeDbCharset(String, String, String, String, String) - start"); //$NON-NLS-1$
		}
		...
		if (logger.isDebugEnabled()) {
			logger.debug("changeDbCharset(String, String, String, String, String) - end"); //$NON-NLS-1$
		}
	}
	...
	public static void createTable(String dbHost, String dbPort, String dbName,
			...
			throws Exception {
		if (logger.isDebugEnabled()) {
			logger.debug("createTable(String, String, String, String, String, List<String>) - start"); //$NON-NLS-1$
		}
		...
		if (logger.isDebugEnabled()) {
			logger.debug("createTable(String, String, String, String, String, List<String>) - end"); //$NON-NLS-1$
		}
	}
	...
	public static void updateConfig(String dbHost, String dbPort,
		...
		if (logger.isDebugEnabled()) {
			logger.debug("updateConfig(String, String, String, String, String, String, String, String) - start"); //$NON-NLS-1$
		}
		...
		if (logger.isDebugEnabled()) {
			logger.debug("updateConfig(String, String, String, String, String, String, String, String) - end"); //$NON-NLS-1$
		}
	}
	...
	public static List<String> readSql(String fileName) throws Exception {
		if (logger.isDebugEnabled()) {
			logger.debug("readSql(String) - start"); //$NON-NLS-1$
		}
		...
		if (logger.isDebugEnabled()) {
			logger.debug("readSql(String) - end"); //$NON-NLS-1$
		}
		return sqlList;
	}
}
