...
public class MyFriendPageDirective implements TemplateDirectiveModel {
	/**
	 * Logger for this class
	 */
	private static final Logger logger = Logger.getLogger(MyFriendPageDirective.class);
	...
	public void execute(Environment env, Map params, TemplateModel[] loopVars,
		...
		Pagination pagination = bbsFriendShipMng.getPageByUserId(userId,
