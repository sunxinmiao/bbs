...
public class BbsMagicAct {
	 ...
	 */
	private static final Logger logger = Logger.getLogger(BbsMagicAct.class);
	...
	public String magicshop(HttpServletRequest request, ModelMap model) {
		if (logger.isDebugEnabled()) {
			logger.debug("magicshop(HttpServletRequest, ModelMap) - start"); //$NON-NLS-1$
		}
		...
		if (user == null) {
			...
			if (logger.isDebugEnabled()) {
				logger.debug("magicshop(HttpServletRequest, ModelMap) - end"); //$NON-NLS-1$
			}
			return returnString;
		}
		BbsMagicConfig magicConfig = magicConfigMng.findById(site.getId());
		if (!magicConfig.getMagicSwitch()) {
			String returnString = FrontUtils.getTplPath(request, site.getSolutionPath(), TPLDIR_MAGIC, TPL_NO_OPEN);
			if (logger.isDebugEnabled()) {
				logger.debug("magicshop(HttpServletRequest, ModelMap) - end"); //$NON-NLS-1$
			}
			return returnString;
		...
		String returnString = FrontUtils.getTplPath(request, site.getSolutionPath(), TPLDIR_MAGIC, TPL_MAGIC_SHOP);
		if (logger.isDebugEnabled()) {
			logger.debug("magicshop(HttpServletRequest, ModelMap) - end"); //$NON-NLS-1$
		}
		return returnString;
	...
	public String magicmybox(HttpServletRequest request, ModelMap model) {
		if (logger.isDebugEnabled()) {
			logger.debug("magicmybox(HttpServletRequest, ModelMap) - start"); //$NON-NLS-1$
		}
		...
		if (user == null) {
			String returnString = FrontUtils.getTplPath(request, site.getSolutionPath(), TPLDIR_TOPIC, TPL_NO_LOGIN);
			if (logger.isDebugEnabled()) {
				logger.debug("magicmybox(HttpServletRequest, ModelMap) - end"); //$NON-NLS-1$
			}
			return returnString;
		}
		BbsMagicConfig magicConfig = magicConfigMng.findById(site.getId());
		...
		String returnString = FrontUtils.getTplPath(request, site.getSolutionPath(), TPLDIR_MAGIC, TPL_MAGIC_MYBOX);
		if (logger.isDebugEnabled()) {
			logger.debug("magicmybox(HttpServletRequest, ModelMap) - end"); //$NON-NLS-1$
		}
		return returnString;
	...
	public String magiclog(Integer pageNo1, Integer pageNo2, Integer pageNo3,
		...
		if (logger.isDebugEnabled()) {
			logger.debug("magiclog(Integer, Integer, Integer, Integer, HttpServletRequest, ModelMap) - start"); //$NON-NLS-1$
		}
		...
		if (user == null) {
			String returnString = FrontUtils.getTplPath(request, site.getSolutionPath(), TPLDIR_TOPIC, TPL_NO_LOGIN);
			if (logger.isDebugEnabled()) {
				logger.debug("magiclog(Integer, Integer, Integer, Integer, HttpServletRequest, ModelMap) - end"); //$NON-NLS-1$
			}
			return returnString;
		}
		BbsMagicConfig magicConfig = magicConfigMng.findById(site.getId());
		...
		FrontUtils.frontData(request, model, site);
		String returnString = FrontUtils.getTplPath(request, site.getSolutionPath(), TPLDIR_MAGIC, TPL_MAGIC_LOG);
		if (logger.isDebugEnabled()) {
			logger.debug("magiclog(Integer, Integer, Integer, Integer, HttpServletRequest, ModelMap) - end"); //$NON-NLS-1$
		}
		return returnString;
	...
	public String getsellmagicpage(String mid, int operator, Integer pid, HttpServletRequest request,
		...
		if (logger.isDebugEnabled()) {
			logger.debug("getsellmagicpage(String, int, Integer, HttpServletRequest, HttpServletResponse, ModelMap) - start"); //$NON-NLS-1$
		}
		...
		if (user == null) {
			String returnString = FrontUtils.getTplPath(request, site.getSolutionPath(), TPLDIR_TOPIC, TPL_NO_LOGIN);
			if (logger.isDebugEnabled()) {
				logger.debug("getsellmagicpage(String, int, Integer, HttpServletRequest, HttpServletResponse, ModelMap) - end"); //$NON-NLS-1$
			}
			return returnString;
		}
		if (!magicConfig.getMagicSwitch()) {
		...
		String returnString = FrontUtils.getTplPath(request, site.getSolutionPath(), TPLDIR_MAGIC, TPL_MAGIC_SELL);
		if (logger.isDebugEnabled()) {
			logger.debug("getsellmagicpage(String, int, Integer, HttpServletRequest, HttpServletResponse, ModelMap) - end"); //$NON-NLS-1$
		}
		return returnString;
	...
	public String getbuymagicpage(String mid, HttpServletRequest request,
			HttpServletResponse response, ModelMap model) {
		if (logger.isDebugEnabled()) {
			logger.debug("getbuymagicpage(String, HttpServletRequest, HttpServletResponse, ModelMap) - start"); //$NON-NLS-1$
		}
		...
		if (user == null) {
			String returnString = FrontUtils.getTplPath(request, site.getSolutionPath(), TPLDIR_TOPIC, TPL_NO_LOGIN);
			if (logger.isDebugEnabled()) {
				logger.debug("getbuymagicpage(String, HttpServletRequest, HttpServletResponse, ModelMap) - end"); //$NON-NLS-1$
			}
			return returnString;
		}
		if (!magicConfig.getMagicSwitch()) {
		...
		String returnString = FrontUtils.getTplPath(request, site.getSolutionPath(), TPLDIR_MAGIC, TPL_MAGIC_BUY);
		if (logger.isDebugEnabled()) {
			logger.debug("getbuymagicpage(String, HttpServletRequest, HttpServletResponse, ModelMap) - end"); //$NON-NLS-1$
		}
		return returnString;
	...
	public void buymagic(String mid, int buynum, HttpServletRequest request,
			HttpServletResponse response, ModelMap model) {
		if (logger.isDebugEnabled()) {
			logger.debug("buymagic(String, int, HttpServletRequest, HttpServletResponse, ModelMap) - start"); //$NON-NLS-1$
		}
		...
		try {
			...
			logger.error("buymagic(String, int, HttpServletRequest, HttpServletResponse, ModelMap)", e); //$NON-NLS-1$
		...
		if (logger.isDebugEnabled()) {
			logger.debug("buymagic(String, int, HttpServletRequest, HttpServletResponse, ModelMap) - end"); //$NON-NLS-1$
		}
	}
	...
	public void sellmagic(String mid, int operator, int num,
			...
			ModelMap model) {
		if (logger.isDebugEnabled()) {
			logger.debug("sellmagic(String, int, int, HttpServletRequest, HttpServletResponse, ModelMap) - start"); //$NON-NLS-1$
		}
		...
		try {
			...
			logger.error("sellmagic(String, int, int, HttpServletRequest, HttpServletResponse, ModelMap)", e); //$NON-NLS-1$
		...
		if (logger.isDebugEnabled()) {
			logger.debug("sellmagic(String, int, int, HttpServletRequest, HttpServletResponse, ModelMap) - end"); //$NON-NLS-1$
		}
	}
	...
	public String getmagicpage(Integer pid, Integer ppid, String mid,
			...
			HttpServletResponse response, ModelMap model) {
		if (logger.isDebugEnabled()) {
			logger.debug("getmagicpage(Integer, Integer, String, String, HttpServletRequest, HttpServletResponse, ModelMap) - start"); //$NON-NLS-1$
		}
		...
		if (user == null) {
			String returnString = FrontUtils.getTplPath(request, site.getSolutionPath(), TPLDIR_TOPIC, TPL_NO_LOGIN);
			if (logger.isDebugEnabled()) {
				logger.debug("getmagicpage(Integer, Integer, String, String, HttpServletRequest, HttpServletResponse, ModelMap) - end"); //$NON-NLS-1$
			}
			return returnString;
		}
		if (!magicConfig.getMagicSwitch()) {
		...
		String returnString = FrontUtils.getTplPath(request, site.getSolutionPath(), TPLDIR_MAGIC, TPL_MAGIC_SHOW);
		if (logger.isDebugEnabled()) {
			logger.debug("getmagicpage(Integer, Integer, String, String, HttpServletRequest, HttpServletResponse, ModelMap) - end"); //$NON-NLS-1$
		}
		return returnString;
	...
	public void usemagic(Integer pid, String mid, String color, Integer userid,
			...
			HttpServletResponse response, ModelMap model) {
		if (logger.isDebugEnabled()) {
			logger.debug("usemagic(Integer, String, String, Integer, String, Integer, HttpServletRequest, HttpServletResponse, ModelMap) - start"); //$NON-NLS-1$
		}
		...
		try {
			...
			logger.error("usemagic(Integer, String, String, Integer, String, Integer, HttpServletRequest, HttpServletResponse, ModelMap)", e); //$NON-NLS-1$
		...
		if (logger.isDebugEnabled()) {
			logger.debug("usemagic(Integer, String, String, Integer, String, Integer, HttpServletRequest, HttpServletResponse, ModelMap) - end"); //$NON-NLS-1$
		}
	}
	...
	private void saveMagicLog(BbsCommonMagic magic, BbsUser user,
		...
		if (logger.isDebugEnabled()) {
			logger.debug("saveMagicLog(BbsCommonMagic, BbsUser, Integer, Byte) - start"); //$NON-NLS-1$
		}
		...
		if (logger.isDebugEnabled()) {
			logger.debug("saveMagicLog(BbsCommonMagic, BbsUser, Integer, Byte) - end"); //$NON-NLS-1$
		}
	}

	private Boolean hasNoPermission(String messageCode) {
		if (logger.isDebugEnabled()) {
			logger.debug("hasNoPermission(String) - start"); //$NON-NLS-1$
		}
		...
		if (messageCode.equals(MagicConstants.MAGIC_OPEN_ERROR_NOIN_MODERATORS)
			...
			if (logger.isDebugEnabled()) {
				logger.debug("hasNoPermission(String) - end"); //$NON-NLS-1$
			}
			return true;
		}
	...
	private int hasPermission(BbsCommonMagic magic, BbsUser user, Integer pid) {
		if (logger.isDebugEnabled()) {
			logger.debug("hasPermission(BbsCommonMagic, BbsUser, Integer) - start"); //$NON-NLS-1$
		}
		...
		if (userGroups == null || userGroups.size() == 0) {
			...
			if (toUserGroups == null || toUserGroups.size() == 0) {
				if (logger.isDebugEnabled()) {
					logger.debug("hasPermission(BbsCommonMagic, BbsUser, Integer) - end"); //$NON-NLS-1$
				}
				return 1;
			} else {
