...
public class BbsKeepSession {
	 ...
	 */
	private static final Logger logger = Logger.getLogger(BbsKeepSession.class);
	...
	public void keepSession(Double interval, HttpServletRequest request,
		...
		if (logger.isDebugEnabled()) {
			logger.debug("keepSession(Double, HttpServletRequest, HttpServletResponse, ModelMap) - start"); //$NON-NLS-1$
		}
		...
		if (logger.isDebugEnabled()) {
			logger.debug("keepSession(Double, HttpServletRequest, HttpServletResponse, ModelMap) - end"); //$NON-NLS-1$
		}
	}
