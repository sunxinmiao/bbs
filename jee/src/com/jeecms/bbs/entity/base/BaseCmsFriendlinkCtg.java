...
public abstract class BaseCmsFriendlinkCtg  implements Serializable {
	 ...
	 */
	private static final Logger logger = Logger.getLogger(BaseCmsFriendlinkCtg.class);
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.jeecms.bbs.entity.CmsFriendlinkCtg)) return false;
		else {
			com.jeecms.bbs.entity.CmsFriendlinkCtg cmsFriendlinkCtg = (com.jeecms.bbs.entity.CmsFriendlinkCtg) obj;
